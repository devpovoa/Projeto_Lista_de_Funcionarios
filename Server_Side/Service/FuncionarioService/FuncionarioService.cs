 ...
 public class FuncionarioService : IFuncionarioInterface
 {
  ...
  public async Task<ServiceResponse<List<FuncionarioModel>>> CreateFuncionarios(FuncionarioModel novoFuncionario)
  {
   ...
   try
   {
    ...
    if (novoFuncionario == null)
    {
     ...
     serviceResponse.Mensagem = "Por favor,informe os dados do funcionário.";
  ...
  public async Task<ServiceResponse<List<FuncionarioModel>>> DeleteFuncionario(int id)
  {
   ...
   try
   {
    ...
    {
     serviceResponse.Dados = null;
     serviceResponse.Mensagem = "Não há funcionário cadastrado.";
     serviceResponse.Sucesso = false;
  ...
  public async Task<ServiceResponse<FuncionarioModel>> GetFuncionarioById(int id)
  {
   ...
   try
   {
    ...
    {
     serviceResponse.Dados = null;
     serviceResponse.Mensagem = "Não existe este funcionário.";
     serviceResponse.Sucesso = false;
     return serviceResponse;
    }
